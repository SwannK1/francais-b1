...
const faqs = [
  ...
  },
  {
    ...
    answer: `Les 26 modules du parcours B1, tous les audios, les productions écrites avec correction détaillée, les examens blancs DELF B1 et le suivi de progression. Voir le détail sur la page Offre.`,
  },
  {
