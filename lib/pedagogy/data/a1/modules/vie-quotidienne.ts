            ...
            exercises: [
              {
                ...
                audioSrc: "/audio/a1/prix-achats/vetements-taille.m4a",
                transcript:
                  "Sophie — Bonjour ! Je cherche cette robe, en taille 38, vous auriez ça ?\nVendeuse — Alors, je vais regarder... Oui, j'en ai une en 38 ! Vous voulez l'essayer ?\nSophie — Oui, avec plaisir. Elle coûte combien ?\nVendeuse — Elle est à quarante-cinq euros. La cabine d'essayage est juste là-bas.\nSophie — D'accord, merci beaucoup !",
                questions: [
                  {
                    kind: "qcm",
                    id: "m06-f1-q1",
            ...
            exercises: [
              {
                ...
                audioSrc: "/audio/a1/dates-heures/jours-semaine.m4a",
                transcript:
                  "Lundi, mardi, mercredi, jeudi, vendredi : ce sont les jours de travail. Samedi et dimanche : c'est le week-end.",
                questions: [
                  {
                    kind: "vrai_faux",
                    id: "m08-f1-q1",
