            ...
            exercises: [
              {
                ...
                skillId: "pe-recit",
                difficulty: "B1",
                instructions: "Prépare les étapes de ton récit, puis enregistre-toi.",
                consigne: "Un proche te demande de raconter une expérience qui t'a marqué·e. Explique ce qui s'est passé, dans quel ordre, et comment tu t'es senti·e.",
                context: "Il s'agit d'un échange personnel : parle naturellement, sans lire ton texte mot à mot.",
                prepSeconds: 45,
                maxSpeakSeconds: 90,
                selfAssessmentCriteria: [
                  "J'ai situé l'expérience et raconté les événements dans un ordre clair.",
                  "J'ai utilisé au moins deux connecteurs chronologiques.",
                  "J'ai exprimé un ressenti et expliqué pourquoi cette expérience m'a marqué·e.",
                  "Mon récit reste compréhensible, même si je fais quelques erreurs.",
                ],
                tips: "Note seulement trois repères : situation, événement principal, ressenti.",
              },
            ],
          },
        ],
            ...
            exercises: [
              {
                ...
                skillId: "voc-logement",
                difficulty: "B1",
                instructions: "Prépare tes questions, puis joue ton côté de la conversation.",
                consigne: "Tu téléphones au propriétaire du studio. Présente-toi, vérifie deux informations importantes et propose un horaire de visite.",
                context: "Le propriétaire répond brièvement entre tes questions : laisse de petites pauses comme dans un vrai appel.",
                prepSeconds: 45,
                maxSpeakSeconds: 75,
                selfAssessmentCriteria: [
                  "Je me suis présenté·e et j'ai expliqué la raison de mon appel.",
                  "J'ai posé deux questions précises sur le logement.",
                  "J'ai proposé un horaire de visite avec une formule polie.",
                  "Mes questions sont assez claires pour obtenir une réponse utile.",
                ],
                tips: "Prépare deux mots-clés, par exemple charges et disponibilité, pas un texte complet.",
              },
            ],
          },
        ],
            ...
            exercises: [
              {
                ...
                skillId: "pe-expliquer-probleme",
                difficulty: "B1",
                instructions: "Prépare les informations essentielles, puis réponds au médecin.",
                consigne: "Le médecin te demande ce qui ne va pas. Décris tes symptômes, précise depuis quand ils durent, explique leur évolution et pose une question sur la suite.",
                context: "Réponds comme pendant une consultation : va du problème principal vers les détails utiles.",
                prepSeconds: 40,
                maxSpeakSeconds: 75,
                selfAssessmentCriteria: [
                  "J'ai décrit clairement le symptôme principal.",
                  "J'ai précisé la durée et l'évolution du problème.",
                  "J'ai posé une question utile au médecin.",
                  "J'ai organisé les informations sans me perdre dans des détails inutiles.",
                ],
                tips: "Suis l'ordre : problème, depuis quand, évolution, question.",
              },
            ],
          },
        ],
            ...
            exercises: [
              {
                ...
                skillId: "pe-expliquer-probleme",
                difficulty: "B1",
                instructions: "Choisis un problème concret, puis enregistre ton appel.",
                consigne: "Tu appelles le service client. Décris précisément le problème, explique pourquoi la première réponse ne te convient pas et propose une solution acceptable.",
                context: "Reste poli·e mais ferme : ton objectif est d'obtenir une réponse concrète.",
                prepSeconds: 50,
                maxSpeakSeconds: 90,
                selfAssessmentCriteria: [
                  "J'ai donné des faits précis pour expliquer le problème.",
                  "J'ai justifié calmement mon désaccord.",
                  "J'ai demandé ou proposé une solution claire.",
                  "Mon ton reste poli et suffisamment ferme.",
                ],
                tips: "Utilise trois étapes : les faits, le désaccord, la solution demandée.",
              },
            ],
          },
        ],
            ...
            exercises: [
              {
                ...
                skillId: "pe-exprimer-avis",
                difficulty: "B1",
                instructions: "Choisis un sujet du module, puis formule une réponse orale structurée.",
                consigne: "Dans une discussion, une personne défend une opinion différente de la tienne. Présente ta position, reconnais un argument valable de l'autre côté, puis justifie ton désaccord ou ta nuance.",
                context: "Tu ne fais pas un discours : tu réponds à quelqu'un dans une conversation respectueuse.",
                prepSeconds: 60,
                maxSpeakSeconds: 100,
                selfAssessmentCriteria: [
                  "J'ai exprimé clairement ma position.",
                  "J'ai reconnu au moins un argument de l'autre point de vue.",
                  "J'ai justifié mon accord partiel, mon désaccord ou ma nuance.",
                  "J'ai relié mes idées avec des connecteurs adaptés.",
                ],
                tips: "Structure utile : je comprends que…, néanmoins…, parce que…",
              },
            ],
          },
        ],
